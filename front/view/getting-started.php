            ...
            <div class="row clearfix justify-content-center">
                <!--Form Column-->
                    <div class="form-column column col-lg-6 col-md-12 col-sm-12">
                        ...
                        $useremil = $_POST['useremil'];
                        $userpassword = $_POST['userpassword'];
                        echo $username ."". $useremil ."". $userpassword;
                        ?>
                        <div class="styled-form register-form">
                                ...
                                <div class="clearfix">
                                    <div class="form-group pull-left">
                                        <button type="submit" name="create" class="theme-btn btn-style-three"><span class="txt">Register here</span></button>
                                    </div>
...
<!-- Mirrored from View/html/gym/account.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 12 Nov 2020 18:53:48 GMT -->
</html>