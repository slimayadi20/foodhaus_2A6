			...
			<div class="container h-full">
				<div class="wrap_header trans-0-3">
					...
					<div class="social flex-w flex-l-m p-r-20">
						...
						<a href="panier.php"><i class="fa ti-shopping-cart m-l-21" aria-hidden="true"></i></a>
...
if (isset($_POST['valider']))
{
	...
	$pan = new panier($_POST['name'],$_POST['price'],$_POST['dir']) ;
	 $panc=new panierC;
   $panc->ajouterPanier($pan) ;
					...
					<div class="wrap-item-mainmenu p-b-22">
						...
						<div class="item-mainmenu m-b-36">
							<div class="flex-w flex-b m-b-3">
								<input hidden name="name" value="Pine nut sbrisalona" href="#" class="name-item-mainmenu txt21">
									Pine nut sbrisalona
</input>

								<div class="line-item-mainmenu bg3-pattern"></div>

								<input hidden value ="29" name="price" class="price-item-mainmenu txt22">
									$29.79
</input>
							...
							<input hidden value="images\photo-gallery-thumb-21.jpg" name="dir" class="info-item-mainmenu txt23">
								<img src="images\photo-gallery-thumb-21.jpg" width="75" height="75">
								<button type="submit" class="btn btn-outline-success"  name="valider"><i class="fa fa-check">Ajouter au Panier</i></button>
</input>
						</div>
						</form>
						...
						<div class="item-mainmenu m-b-36">
							<div class="flex-w flex-b m-b-3">
								<input hidden name="name" value="Aenean eu" href="#" class="name-item-mainmenu txt21">
									Aenean eu
</input>

								<div class="line-item-mainmenu bg3-pattern"></div>

								<input hidden value ="19.35" name="price"  class="price-item-mainmenu txt22">
									$19.35
</input>
							</div>

							<input hidden value="images\photo-gallery-thumb-20.jpg" name="dir" class="info-item-mainmenu txt23">
							<img src="images\photo-gallery-thumb-20.jpg" width="75" height="75">
							<button type="submit" class="btn btn-outline-success"  name="valider"><i class="fa fa-check">Ajouter au Panier</i></button>
</input>
						</div>
</form>
						...
						<div class="item-mainmenu m-b-36">
							<div class="flex-w flex-b m-b-3">
								<input hidden name="name" value="Sed feugiat" href="#" class="name-item-mainmenu txt21">
									Sed feugiat
</input>

								<div class="line-item-mainmenu bg3-pattern"></div>

								<input hidden value ="12.19" name="price" class="price-item-mainmenu txt22">
									$12.19
</input>
							</div>

							<input hidden value="images\photo-gallery-thumb-19.jpg" name="dir" class="info-item-mainmenu txt23">
							<img src="images\photo-gallery-thumb-19.jpg" width="75" height="75">
							<button type="submit" class="btn btn-outline-success"  name="valider"><i class="fa fa-check">Ajouter au Panier</i></button>
</input>
						</div>
</form>
						...
						<div class="item-mainmenu m-b-36">
							<div class="flex-w flex-b m-b-3">
								<input hidden name="name" value="Consectetur" href="#" class="name-item-mainmenu txt21">
									Consectetur
								</a>

								<div class="line-item-mainmenu bg3-pattern"></div>

								<input hidden value ="21.89" name="price" class="price-item-mainmenu txt22">
									$21.89
</input>
							</div>

							<input hidden value="images\photo-gallery-thumb-18.jpg" name="dir" class="info-item-mainmenu txt23">
							<img src="images\photo-gallery-thumb-18.jpg" width="75" height="75">
							<button type="submit" class="btn btn-outline-success"  name="valider"><i class="fa fa-check">Ajouter au Panier</i></button>
</input>
						</div>
					</div>
