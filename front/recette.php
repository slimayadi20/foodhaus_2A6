...
<body class="animsition">
	...
	<?php
include "../backoffice/controller/Recette_C.php";  
include "../backoffice/model/Recette.php";

$recetteC = new Recette_C();
$recettes = $recetteC->afficherrecette();
...
?>
<!-- Video -->
<section class="section-video parallax100" style="background-image: url(images/<?php echo $recette["img_recette"]; ?>);">
			...
			<div class="container">
				<div class="flex-sb-m flex-w p-t-22 p-b-22">
					...
					<div class="txt17 p-r-20 p-t-5 p-b-5">
						Copyright &copy; 2021 All rights reserved  |  This template is made with <i class="fa fa-heart"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a>
					</div>
				</div>
			</div>
		</div>
