		...
		<div class="container">
			...
			?>
							...
							<form class="leave-comment p-t-10" action="event.php" method="post">
								...
								include "D:/wamp/www/projet_web/backoffice/controller/participant_C.php";
								include "D:/wamp/www/projet_web/backoffice/model/participant.php";
								require_once "./db.php"; //la connexion avec la bd
								...
								<div class="size30 bo2 bo-rad-10 m-t-3 m-b-20">
									<input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="name" onblur="lett(this)" placeholder="Name *" required>
								</div>

								<div class="size30 bo2 bo-rad-10 m-t-3 m-b-20">
									<input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="mail" onblur="ValidateEmail(this)" placeholder="Email *" required>
								</div>
