...
<body class="animsition">
					...
					<div class="wrap_menu p-l-45 p-l-0-xl">
						<nav class="menu">
							<ul class="main_menu">
								...
								<li>
									<a href="reservation.html">Restaurant</a>
								</li>

								<li>
									<a href="gallery.html">Recette&chefs</a>
								</li>

								<li>
									<a href="about.html">Formations</a>
								</li>

								<li>
									<a href="blog.html">Evenements</a>
								</li>
	...
	<aside class="sidebar trans-0-4">
		...
		<ul class="menu-sidebar p-t-95 p-b-70">
			...
			<li class="t-center m-b-13">
				<a href="events.php" class="txt19">Evenements</a>
			</li>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-8 col-lg-9">
					...
					<?php
					include "../backoffice/controller/evenement_C.php";
					include "../backoffice/model/evenement.php";
						...
						<div class="blo4 p-b-63">
							...
							<div class="pic-blo4 hov-img-zoom bo-rad-10 pos-relative">
								<a href="event.php">
									...
									<img src="./images/<?php echo $img; ?>" alt="IMG-BLOG">
								</a>
