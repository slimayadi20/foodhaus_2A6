...
<section>
	...
	<div class="container">
		<iframe width="1200" height="400" src="https://www.youtube.com/embed/aLD7jhMyXow" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		...
		<ul class="cards">
			...
			<table colspam="6" class="table">
				...
				?>
					...
					<li class="cards_item">
						<div class="card">
							<div class="card_image"><img src=" ./images/<?PHP echo $row['imgpath'];
			...
			<div class="row">
				<div class="col-sm-6 col-md-4 p-t-50">
					...
					<ul class="m-b-70">
						<li class="txt14 m-b-14">
							...
							Residence Narjess 3,bloc C,2eme etage, la petite ariana,La gazelle
						</li>
				...
				<div class="col-sm-6 col-md-4 p-t-50">
					...
					<h4 class="txt13 m-b-38">
						Des photos sur nos formations recentes
					</h4>
			...
			<div class="container">
				<div class="flex-sb-m flex-w p-t-22 p-b-22">
					...
					<div class="txt17 p-r-20 p-t-5 p-b-5">
						Copyright &copy; 2021 All rights reserved | This template is made with Fekret'Com group
					</div>
				</div>
			</div>
		</div>
