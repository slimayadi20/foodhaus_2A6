			...
			<div class="col-md-8 col-lg-6 m-l-r">
				...
				<div class="blo5 pos-relative p-t-60">
						...
						<div class="text-blo5 size34 t-center bo-rad-10 bo7 p-t-90 p-l-35 p-r-35 p-b-30">
							...
							<p class="t-center">
							<a href="chef.php?id_chef=<?PHP echo $id_chef; ?>"><img src="images/<?php echo $img_plat1_chef; ?>" alt="IGM-AVATAR"></a>
							</p>
						</div>
					</div>
				</div>
			...
			<div class="col-md-8 col-lg-6 m-l-r-auto">
				...
				<div class="blo5 pos-relative p-t-60">
						...
						<div class="text-blo5 size34 t-center bo-rad-10 bo7 p-t-90 p-l-35 p-r-35 p-b-30">
							...
							<p class="t-center">
								<a href="chef.php?id_chef=<?PHP echo $id_chef1; ?>"><img src="images/<?php echo $img_plat1_chef1; ?>" alt="IGM-AVATAR"></a>
							</p>
						</div>
					</div>
				</div>
