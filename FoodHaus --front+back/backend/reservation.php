                    ...
                    <div class="datatable table-responsive">
                        <table class="table table-bordered table-hover" id="tblData" width="100%" cellspacing="0">
                            <a class="btn btn-primary mr-2 my-1" tabindex="0" aria-controls="datatable-buttons"
                               href="reservation.php" onclick="CopyToClipboard('tblData')"><span>Copier</span></a>
                            <a class="btn btn-primary mr-2 my-1" tabindex="0" aria-controls="datatable-buttons"
                               href="./pdf_genrator/generate_pdfreservation.php"><span>PDF</span></a>
                            <a class="btn btn-primary mr-2 my-1" tabindex="0" aria-controls="datatable-buttons"
                               href="reservation.php" onclick="exportTableToExcel('tblData')"><span>Excel</span></a>
