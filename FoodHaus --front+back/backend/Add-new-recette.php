                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            if (isset($_POST['create'])) {
                                ...
                                $sql = "INSERT INTO recette (nom_recette,img_recette,descprition_recette,temp_recette,type_recette) values (:nom_recette, :img_recette , :descprition_recette, :temp_recette,:type_recette) ";
                            ...
                            <form action="add-new-recette.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="title">image recette:</label>
                                    <input name="img_recette" class="form-control" id="nom" type="text" placeholder="image" />
                                </div>
                                <div class="form-group">
