							...
							if (isset($_COOKIE['_uid_']) || isset($_COOKIE['_uiid_']) || isset($_SESSION['login'])) { ?>
								<form class="wrap-form-reservation size22 m-l-r-auto" action="contact.php" method="POST">
									...
									<div class="size30 bo2 bo-rad-10 m-t-3 m-b-20">
										<input value="<?php echo $user_name; ?>" readonly="true" class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="name">
									</div>

									<div class="size30 bo2 bo-rad-10 m-t-3 m-b-20">
										<input class="bo-rad-10 sizefull txt10 p-l-20" value="<?php echo $user_email; ?>" readonly="true" type="text" name="mail">
									</div>
