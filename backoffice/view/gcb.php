...
include "../controller/coursC.php";
	 ...
	 $cours=new coursC;
    if (isset($_GET['key'])) {
        $listC = $cours->recherchecours($_GET['key']);
    } else {
...
{   
$req="DELETE from cours where id=".$_POST['id'];
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="gb.php">Gestion formateurs</a></li>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="page-title-box">
                                        ...
                                        <h4 class="page-title">Gestion des cours</h4>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-13">
                                            ...
                                            <h4 class="mt-0 header-title">Les cours</h4>
                                            <table class="table">
                                                <thead>
                                                <tr>
...
<div>
<h5  style="color: white; background-color: green; width: 200px;" align="center"> <?php echo('cours:'.$total)?></h5>
...
<a   type="button" class="btn btn-outline-success"  href="generate_pdf.php" role="button"><i class="fas fa-plus-circle"></i> </a>
