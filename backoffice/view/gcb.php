...
include "../controller/commandeC.php";
	 ...
	 $comm=new commandeC;
    if (isset($_GET['key'])) {
        $listC = $comm->rechercheCommande($_GET['key']);
    } else {
        $listC = $comm->afficherCommande();
    }


if (isset ($_POST['supprimer']))
{   
$req="DELETE from commande where idCommande=".$_POST['idCommande'];
...
{  
            ...
            $req="SELECT * FROM commande ORDER BY idCommande ASC";
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="page-title-box">
                                        ...
                                        <h4 class="page-title">Gestion Commandes Blog</h4>
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?PHP echo $row['ville'];
                                                                ...
                                                                <td>
                                                            <?PHP echo $row['nomCarte'];
                                                           
                                                                ?>
                                                                </td>
                                                                <td>
                                                            <?PHP echo $row['numCarte'];
                                                           
                                                                ?>
                                                                </td>
                                                                <td>
                                                            <?PHP echo $row['moisExp'];
                                                           
                                                                ?>
                                                                </td>
                                                                <td>
                                                            <?PHP echo $row['anneeExp'];
                                                            ...
                                                            <input class="btn btn-primary btn-block" type="hidden" value="<?php echo $row['idCommande']; ?>" name="idCommande">
                                                            </form>
                                                            </td>
                                                            <td>
                                                            <a  type="button" class="btn btn-outline-primary"  href="modifierC.php?idCommande=<?php echo $row['idCommande']; ?>" role="button"><i class="fas fa-pen-square"></i> </a>
                                                      <!--      <a class="btn btn-primary btn-block" href="modifierC.php?id=<?php echo $row['idCommande'] ?>">
                                                            Modifier
                                                            </a>-->
                                                            </td>
                                                        </tr>
...
<select name="dropdown" > 
    ...
    <option  value="Par id">Par id</option>
</select>
<button type="submit" class="btn btn-outline-primary"  name="trii" value="trii"><i class="fas fa-unsorted"></i></button>
                                            </form>
