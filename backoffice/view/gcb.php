...
$chef=new Chef_C;
    if (isset($_GET['key'])) {
        $listC = $chef->recherchechef($_GET['key']);
    } else {
        $listC = $chef->afficherchef();
    }


if (isset ($_POST['supprimer']))
{   
$req="delete from chefs where id_chef=".$_POST['id_chef'];
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="gb.php">Gestion des recettes</a></li>
                                    <li><a href="http://localhost/projet_web/backoffice/view/gcb.php">Gestion des chefs</a></li>
                                </ul>
                            </li>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="page-title-box">
                                        ...
                                        <h4 class="page-title">Gestion des Chefs</h4>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="">
                                        <div class="">
                                            ...
                                            <h4 class="mt-0 header-title">chef</h4>
    
                                            <form method="POST" action="gcb.php" >
                                            <button  class="btn btn-outline-primary" type="submit" name="TriDesc" value="TriDesc"><i class="ti-arrow-up"></i></button>
                                            </form>
                                            <table id="tblData" class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <th>nom</th>
                                                    <th>descriptions</th>
                                                    <th>lien_video_chef</th>
                                                    <th>img_video_chef</th>
                                                    <!--<th>nom_plat1_chef</th>
                                                    <th>nom_plat2_chef</th>
                                                    <th>citation_chef</th>
                                                    <th>img_plat1_chef</th>
                                                    <th>img_plat2_chef</th>-->
                                                    <th>id_chef</th>
                                                </tr>
                                                </thead>
                                                <?PHP
                                                    ...
                                                    <tbody>
                                                        <tr> 
                                                            ...
                                                            <?PHP echo $row['descriptions'];
                                                                ...
                                                                <td>
                                                                <?PHP echo $row['lien_video_chef']; ?>
                                                            </td>
                                                            <td>
                                                                <?PHP echo $row['img_video_chef']; ?>
                                                            </td>

                                                            

                                                            <!--<td>
                                                                <?PHP echo $row['nom_plat1_chef']; ?>
                                                            </td>
                                                            <td>
                                                                <?PHP echo $row['nom_plat2_chef']; ?>
                                                            </td>
                                                            <td>
                                                               <?PHP echo $row['citation_chef']; ?>
                                                            </td>
                                                            <td>
                                                                <?PHP echo $row['img_plat1_chef']; ?>
                                                            </td>
                                                            <td>
                                                                <?PHP echo $row['img_plat2_chef']; ?>
                                                            </td> -->
                                                            <td>
                                                            ...
                                                            <input class="btn btn-primary btn-block" type="hidden" value="<?php echo $row['id_chef']; ?>" name="id_chef">
                                                            </form>
                                                            </td>
                                                            <br>
                                                            <td>
                                                            <a  type="button" class="btn btn-outline-primary"  href="modifierC.php?id_chef=<?php echo $row['id_chef']; ?>" role="button"><i class="fas fa-pen-square"></i> </a>
                                                      <!--      <a class="btn btn-primary btn-block" href="modifierC.php?id_chef=<?php echo $row['id_chef'] ?>">
                                                            Modifier
                                                            </a>-->
