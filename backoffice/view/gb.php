...
include "../controller/participant_C.php";
    ...
    if (!isset($_GET['key'])) {
        ...
        $listC = $participant->afficherparticipant();
    }
    if (isset ($_POST['supprimer']))
    {   
    $req="delete from participant where id_participant=".$_POST['id_participant'];
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="gb.html">Gestion participants</a></li>
                                    <li><a href="gcb.php">Gestion evenements</a></li>
                                </ul>
                            </li>
                    ...
                    <div class="page-content-wrapper ">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="page-title-box">
                                        ...
                                        <h4 class="page-title">Gestion participant </h4>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                            ...
                                            <h4 class="mt-0 header-title">participant </h4>
                                                ...
                                                foreach ($listC as $row) {
                                                    ...
                                                    <tbody>
                                                        <tr> 
                                                            ...
                                                            <input class="btn btn-primary btn-block" type="hidden" value="<?php echo $row['id_participant']; ?>" name="id_participant">
                                                            </form>
                                                            </td>
                                                        </tr>
