...
include "../controller/formateurC.php";
    ...
    if (isset($_GET['key'])) {
        $listC = $formateur->rechercheformateur($_GET['key']);
    } else {
        $listC = $formateur->afficherformateur();
    }


if (isset ($_POST['supprimer']))
{   
$req="delete from formateur where id=".$_POST['id'];
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="gb.html">Gestion formateurs</a></li>
                                    <li><a href="gcb.php">Gestion Cours</a></li>
                                </ul>
                            </li>
                ...
                <div class="content">
                    ...
                    <div class="page-content-wrapper ">
                        ...
                        <div class="container-fluid">
                            ...
                            <button onclick="CopyToClipboard('tblData')">Copy</button> 
                                ...
                                <div class="col-lg-6">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title">formateurs</h4>
                                                ...
                                                foreach ($listC as $row) {
                                                    ...
                                                    <tbody>
                                                        <tr> 
                                                            ...
                                                            <td>
                                                            <a  type="button" class="btn btn-outline-primary"  href="modifierF.php?id=<?php echo $row['id']; ?>" role="button"><i class="fas fa-pen-square"></i> </a>
                                                      <!--      <a class="btn btn-primary btn-block" href="modifierF.php?id=<?php echo $row['id'] ?>">
                                                            Modifier
                                                            </a>-->
                                                            </td>
                                                        </tr>
...
<div>
<h5  style="color: white; background-color: green; width: 200px;" align="center"> <?php echo('Formateurs:'.$total)?></h5>

<form method="get" action="AjouterF.php" align="center">
<a   type="button" class="btn btn-outline-success"  href="AjouterF.php" role="button"><i class="fas fa-plus-circle"></i> </a>
