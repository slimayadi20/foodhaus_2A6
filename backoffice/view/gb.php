...
include "../controller/livraisonC.php";
    ...
    if (isset($_GET['key'])) {
        $listC = $livraison->rechercheLivraison($_GET['key']);
    } else {
        $listC = $livraison->afficherLivraison();
    }


if (isset ($_POST['supprimer']))
{   
$req="DELETE FROM livraisons where idLivraison=".$_POST['idLivraison'];
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="gb.html">Gestion Livraisons Blog</a></li>
                                    <li><a href="gcb.php">Gestion Commandes Blog</a></li>
                                </ul>
                            </li>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="page-title-box">
                                        ...
                                        <h4 class="page-title">Gestion Livraisons Blog</h4>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                foreach ($listC as $row) {
                                                    ...
                                                    <tbody>
                                                        <tr> 
                                                            ...
                                                            <input class="btn btn-primary btn-block" type="hidden" value="<?php echo $row['idLivraison']; ?>" name="idLivraison">
                                                            </form>
                                                            </td>
                                                            <td>
                                                            <a  type="button" class="btn btn-outline-primary"  href="modifierL.php?idLivraison=<?php echo $row['idLivraison']; ?>" role="button"><i class="fas fa-pen-square"></i> </a>
                                                            </td>
                                                        </tr>
...
<form method="get" action="AjouterL.php" align="center">
<a   type="button" class="btn btn-outline-success"  href="AjouterL.php" role="button"><i class="fas fa-plus-circle"></i> </a>
	  			</div>
                                        </div>
                                    </div>
                                </div> <!-- end col -->
