...
$recette=new recette_C;
    if (isset($_GET['key'])) {
        $listC = $recette->rechercherecette($_GET['key']);
    } else {
        $listC = $recette->afficherrecette();
    }
    ...
    {   
    $req="delete from recette where id_recette=".$_POST['id_recette'];
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="http://localhost/projet_web/backoffice/view/gb.php">Gestion Recette</a></li>
                                    <li><a href="gcb.php">Gestion Chef</a></li>
                                </ul>
                            </li>
                                ...
                                <div class="col-lg-6">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title">recette </h4>
                                            <table class="table">
                                                <thead>
                                                <tr>
                                                    <th>Nom_recette</th>
                                                ...
                                                foreach ($listC as $row) {
                                                    ...
                                                    <tbody>
                                                        <tr> 
                                                            ...
                                                            <td>
                                                                <?PHP echo $row['img_recette']; 
                                                                ?>
                                                            </td>
                                                            <td>
                                                                <?PHP echo $row['descprition_recette']; 
                                                                ?>
                                                            </td>
                                                            <td>
                                                                <?PHP echo $row['temp_recette']; 
                                                                ?>
                                                            </td>
                                                            <td>
                                                                <?PHP echo $row['type_recette']; 
                                                                ?>
                                                            </td>
                                                            ...
                                                            <input class="btn btn-primary btn-block" type="hidden" value="<?php echo $row['id_recette']; ?>" name="id_recette">
                                                            </form>
                                                            </td>
                                                            <td>
                                                            <a  type="button" class="btn btn-outline-primary"  href="modifierP.php?id=<?php echo $row['id_recette']; ?>" role="button"><i class="fas fa-pen-square"></i> </a>
                                                      <!--      <a class="btn btn-primary btn-block" href="modifierC.php?id=<?php echo $row['id_recette'] ?>">
                                                            Modifier
                                                            </a>-->
                                            ...
                                            <h5  style="color: white; background-color: green; width: 200px;" align="center"> <?php echo('Total de recette:'.$total)?></h5>
<div>
<form method="get" action="AjouterP.php" align="center">
<a   type="button" class="btn btn-outline-success"  href="AjouterP.php" role="button"><i class="fas fa-plus-circle"></i> </a>
	  			</div>
                                        </div>
                                    </div>
                                </div> <!-- end col -->
