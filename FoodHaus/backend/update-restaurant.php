    ...
    <div id="layoutSidenav_content">
        <main>
            ...
            if (isset($_POST['edit-user'])) {
                $id = $_POST['id'];
                $url = "http://localhost/foodhaus/backend/update-restaurant.php?id=" . $id;
                header("Location: {$url}");
            }
            ...
            <div class="container-fluid mt-n10">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="update-restaurant.php?id=<?php echo $_GET['id']; ?>" method="POST" enctype="multipart/form-data">
