                        ...
                        <div class="card-body">
                            <div class="datatable table-responsive">
                                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                    <a class="btn btn-primary mr-2 my-1" tabindex="0" aria-controls="datatable-buttons" href="Formateur.php" onclick="CopyToClipboard('dataTable')"><span>Copy</span></a>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th onclick="sortTable(3)">SPECIALITE</th>
                                            <th>EDIT</th>
                                            <th>DELETE</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="Formateur-update.php" method="POST">
