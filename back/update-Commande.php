        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                if (isset($_POST['edit-user'])) {
                    $idCommande = $_POST['idCommande'];
                    $url = "http://localhost/foodhaus_2A6-main/back/updateC.php?idCommande=" . $idCommande;
                    header("Location: {$url}");
                }
                        ...
                        <div class="card-body">
                            ...
                            <div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="<?php echo $cvv; ?>" name="cvv" class="form-control" id="formateur-email" type="text" maxlength="3"  placeholder="formateur Email..." />
                                </div>
