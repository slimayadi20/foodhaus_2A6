        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                if (isset($_POST['edit-user'])) {
                    ...
                    $url = "http://localhost/foodhaus_2A6-main/back/updateL.php?idLivraison=" . $idLivraison;
                    header("Location: {$url}");
                }
                ...
                <div class="container-fluid mt-n10">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="updateL.php?idLivraison=<?php echo $_GET['idLivraison']; ?>" method="POST" enctype="multipart/form-data">
