                        ...
                        <div class="card-body">
                            <div class="datatable table-responsive">
                                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0"> 
                                    <a class="btn btn-primary mr-2 my-1" tabindex="0" aria-controls="datatable-buttons" href="Evenement.php" onclick="CopyToClipboard('dataTable')"><span>Copy</span></a>
                                    <a class="btn btn-primary mr-2 my-1" tabindex="0" aria-controls="datatable-buttons" href="generate_pdf.php"><span>PDF</span></a>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th onclick="sortTable(2)">NBR PLACE</th>
                                            <th onclick="sortTable(3)">DATE</th>
                                            <th onclick="sortTable(4)">DESCRIPTION</th>
                                            <th onclick="sortTable(5)">IMG</th>
