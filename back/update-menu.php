    ...
    <div id="layoutSidenav_content">
        <main>
            ...
            if (isset($_POST['edit-user'])) {
                $idMenu = $_POST['idMenu'];
                $url = "http://localhost/foodhaus_2A6-main/back/update-menu.php?idMenu=" . $idMenu;
                header("Location: {$url}");
            }
            ...
            <div class="container-fluid mt-n10">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="maj-menu.php?idMenu=<?php echo $_GET['idMenu']; ?>" method="POST" encentrees="multipart/form-data">
