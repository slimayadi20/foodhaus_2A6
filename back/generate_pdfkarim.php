...
include_once("D:/wamp/www/backend/libs/fpdf.php");
...
$result = mysqli_query($connString, "SELECT  nom,  adresse,codePostal,pays,ville,nomCarte,email FROM commande") or die("database error:". mysqli_error($connString));
