        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                if (isset($_POST['edit-user'])) {
                    $idCommande = $_POST['idCommande'];
                    $url = "http://localhost/backend/updateC.php?idCommande=" . $idCommande;
                    header("Location: {$url}");
                }
                ...
                <div class="container-fluid mt-n10">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="updateC.php?idCommande=<?php echo $_GET['idCommande']; ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="<?php echo $email; ?>" name="email" class="form-control" id="formateur-email" type="text" onblur="lett(this)" placeholder="formateur Email..." />
                                </div>
                                <div class="form-group">
                                    <label for="formateur-email">Adresse:</label>
                                    <input value="<?php echo $adresse; ?>" name="adresse" class="form-control" id="formateur-email" type="text" onblur="lett(this)" placeholder="formateur Email..." />
                                </div>
                                <div class="form-group">
                                    <label for="formateur-email">Code Postal:</label>
                                    <input value="<?php echo $codePostal; ?>" name="codePostal" class="form-control" id="formateur-email" type="text" onblur="lett(this)" placeholder="formateur Email..." />
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="<?php echo $numCarte; ?>" name="numCarte" class="form-control" id="formateur-email" type="text" onblur="lett(this)" placeholder="formateur Email..." />
                                </div>
                                <div class="form-group">
                                    <label for="formateur-email">Mois dexp:</label>
                                    <input value="<?php echo $moisExp; ?>" name="moisExp" class="form-control" id="formateur-email" type="text" onblur="lett(this)" placeholder="formateur Email..." />
                                </div>
                                <div class="form-group">
                                    <label for="formateur-email">Année dexp:</label>
                                    <input value="<?php echo $anneeExp; ?>" name="anneeExp" class="form-control" id="formateur-email" type="text" onblur="lett(this)" placeholder="formateur Email..." />
                                </div>
                                <div class="form-group">
                                    <label for="formateur-email">CVV:</label>
                                    <input value="<?php echo $cvv; ?>" name="cvv" class="form-control" id="formateur-email" type="text" onblur="lett(this)" placeholder="formateur Email..." />
                                </div>
