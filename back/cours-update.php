        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                if (isset($_POST['edit-user'])) {
                    $id = $_POST['id'];
                    $url = "http://localhost/backend/cours-update.php?id=" . $id;
                    header("Location: {$url}");
                }
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="cours-update.php?id=<?php echo $_GET['id']; ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="cours-email">cours nomf:</label>
                                    <input value="<?php echo $nomf; ?>" name="nomf" class="form-control" id="cours-email"  onblur="lett(this)" type="text" placeholder="cours Email..." />
                                </div>
                                <div class="form-group">
